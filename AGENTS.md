...
- `.github/workflows/ard-catalog.yml`, `.github/workflows/sitemap.yml`, and `.github/workflows/plugin-listing.yml` push to `main` using the default `GITHUB_TOKEN`; don't broaden their `permissions` beyond `contents: write`.
