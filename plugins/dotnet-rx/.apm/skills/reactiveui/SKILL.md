...
- Load the [Rx.NET skill](../dotnet-rx/SKILL.md) for generic observable contracts, operator semantics, multicasting, backpressure limits, and System.Reactive testing details.
